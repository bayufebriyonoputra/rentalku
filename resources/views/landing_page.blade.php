        ...
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="/login" class="btn btn-primary-gradient rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Login</a>
                </div>
            </nav>
                ...
                <div class="container px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-8 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">Aplikasi untuk pemesanan rental</h1>
                            <p class="text-white pb-3 animated slideInDown">
                                Rentalku memudahkan Anda untuk menyewa berbagai barang seperti mobil, alat elektronik, dan peralatan rumah tangga. Temukan barang yang Anda butuhkan dan nikmati proses sewa yang cepat dan aman. Hemat waktu dan biaya dengan Rentalku, solusi penyewaan yang praktis dan terpercaya.</p>
                        ...
                        <div class="col-lg-4 d-flex justify-content-center justify-content-lg-end wow fadeInUp" data-wow-delay="0.3s">
                            <div class="owl-carousel screenshot-carousel">
                                {{-- <img class="img-fluid" src="{{ asset('landing_page/img/screenshot-1.png') }}" alt="">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3">Varian Terlengkap</h5>
                            <p class="m-0">Temukan beragam pilihan barang mulai dari mobil mewah hingga peralatan camping terbaik. Rentalku memberikan akses kepada Anda untuk memilih varian yang sesuai dengan kebutuhan dan gaya hidup Anda.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3">Proses Sewa Cepat</h5>
                            <p class="m-0">Nikmati proses sewa yang cepat dan efisien dengan Rentalku. Dengan beberapa langkah sederhana, Anda dapat memesan barang yang diinginkan tanpa repot, menghemat waktu berharga Anda.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3">Jaminan Keamanan Terjamin</h5>
                            <p class="m-0">Rentalku mengutamakan keamanan. Setiap barang yang disewakan melalui platform kami melewati pemeriksaan ketat dan pemeliharaan berkala, memastikan Anda mendapatkan barang dalam kondisi terbaik dan aman untuk digunakan.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3">Ulasan dan Peringkat</h5>
                            <p class="m-0">Baca ulasan dari pengguna lain sebelum Anda menyewa. Dapatkan wawasan dari pengalaman mereka untuk membuat keputusan yang lebih cerdas dan tepat saat memilih barang untuk disewa.
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3"> Layanan Pelanggan 24/7</h5>
                            <p class="m-0">Tim dukungan pelanggan kami siap membantu Anda kapan saja Anda membutuhkannya. Pertanyaan, masalah, atau bantuan teknis, kami hadir untuk memberikan solusi terbaik bagi Anda.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3">Penyewaan Fleksibel</h5>
                            <p class="m-0">Dengan opsi penyewaan harian, mingguan, atau bulanan, Rentalku memberikan fleksibilitas bagi Anda untuk menyesuaikan masa sewa sesuai dengan rencana dan kebutuhan Anda.</p>
                        </div>
                    </div>
                </div>
            </div>
